<template>
	<view class="position-relative" style="width: 135rpx;height: 135rpx;;">
		<image class="position-absolute" src="@/static/images/covericon.jpg" style="width: 135rpx;height: 135rpx;border-radius: 20rpx;left:0;top:0;">
		<image :src="shabi" style="width: 135rpx;height: 135rpx;border-radius: 20rpx;">
	</view>
</template>
